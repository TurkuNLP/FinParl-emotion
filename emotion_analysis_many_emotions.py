...
# Give model id
MODEL_ID = "many_emotions_1_finparl_test"
...
#Load dataset
filepath = "../data/many_emotions/"
dataset = datasets.load_dataset("csv", data_files={"train": os.path.join(filepath, "many_emotions_fi_train.tsv"),
                                                   "validation": os.path.join(filepath, "many_emotions_fi_validation.tsv"),
                                                   "test": os.path.join(filepath, "gpt4_annotations_me_labels_test.tsv"),
                                                  },
                                sep = "\t",
                                cache_dir = "../../hf_cache"
                               )

label_names = ["anger", "fear", "joy", "love", "sadness", "surprise", "neutral"]
