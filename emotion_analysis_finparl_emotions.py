...
#Load dataset
filepath = "../data/gpt4_annotations/"
dataset = datasets.load_dataset("csv", data_files={"train": os.path.join(filepath, "gpt4_annotations_train.tsv"),
                                                   "validation": os.path.join(filepath, "gpt4_annotations_validation.tsv"),
                                                   "test": os.path.join(filepath, "gpt4_annotations_test.tsv"),
                                                  },
                                sep = "\t",
                                cache_dir = "../../hf_cache"
                               )

label_names = ["neutral", "joy-success", "hopeful-optimistic-trust", "love-compliments", "positive_surprise", "sadness-disappointment", "fear-worry-distrust", "hate-disgust-taunts-mockery", "negative_surprise"]
...
def optuna_hp_space(trial):
    return {
        ...
        "warmup_steps":trial.suggest_categorical("warmup_steps", [0, 500]),
    }
